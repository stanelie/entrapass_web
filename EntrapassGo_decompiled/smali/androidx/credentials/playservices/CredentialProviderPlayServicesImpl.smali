...
# direct methods
.method public static synthetic $r8$lambda$DXdUqnt3NaHNieUz1yrHmEmv-IE(Landroidx/credentials/playservices/CredentialProviderPlayServicesImpl;Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;LN/k;Ljava/lang/Exception;)V
    .locals 0

    .line 1
    invoke-static {p0, p1, p2, p3, p4}, Landroidx/credentials/playservices/CredentialProviderPlayServicesImpl;->onClearCredential$lambda$2(Landroidx/credentials/playservices/CredentialProviderPlayServicesImpl;Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;LN/k;Ljava/lang/Exception;)V
...
.method public static synthetic $r8$lambda$KkkjfkO_ppPgKkxx-IfBnKmqAeg(Ld3/l;Ljava/lang/Object;)V
    .locals 0

    .line 1
    invoke-static {p0, p1}, Landroidx/credentials/playservices/CredentialProviderPlayServicesImpl;->onClearCredential$lambda$0(Ld3/l;Ljava/lang/Object;)V
...
.method private static final onClearCredential$lambda$0(Ld3/l;Ljava/lang/Object;)V
    .locals 1
    ...
    .line 5
    .line 6
    invoke-interface {p0, p1}, Ld3/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final onClearCredential$lambda$2(Landroidx/credentials/playservices/CredentialProviderPlayServicesImpl;Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;LN/k;Ljava/lang/Exception;)V
    .locals 1
    ...
    .line 24
    .line 25
    invoke-direct {v0, p4, p2, p3}, Landroidx/credentials/playservices/CredentialProviderPlayServicesImpl$onClearCredential$2$1$1;-><init>(Ljava/lang/Exception;Ljava/util/concurrent/Executor;LN/k;)V

    .line 26
    .line 27
    .line 28
    invoke-virtual {p0, p1, v0}, Landroidx/credentials/playservices/CredentialProviderPlayServicesImpl$Companion;->cancellationReviewerWithCallback$credentials_play_services_auth_release(Landroid/os/CancellationSignal;Ld3/a;)V
...
.method public onClearCredential(LN/a;Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;LN/k;)V
    .locals 3
    ...
    .line 36
    .line 37
    invoke-direct {v0, p2, p3, p4}, Landroidx/credentials/playservices/CredentialProviderPlayServicesImpl$onClearCredential$1;-><init>(Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;LN/k;)V
    ...
    .line 43
    invoke-direct {v1, v0, v2}, Landroidx/credentials/playservices/a;-><init>(Ld3/l;I)V
    ...
    .line 51
    .line 52
    invoke-direct {v0, p0, p2, p3, p4}, Landroidx/credentials/playservices/b;-><init>(Landroidx/credentials/playservices/CredentialProviderPlayServicesImpl;Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;LN/k;)V
...
.method public onCreateCredential(Landroid/content/Context;LN/b;Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;LN/k;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public onGetCredential(Landroid/content/Context;LN/u;Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;LN/k;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    :cond_0
    invoke-virtual {v0, p2}, Landroidx/credentials/playservices/CredentialProviderPlayServicesImpl$Companion;->isGetSignInIntentRequest$credentials_play_services_auth_release(LN/u;)Z
    ...
    invoke-virtual {v0, p2, p5, p4, p3}, Landroidx/credentials/playservices/controllers/GetSignInIntent/CredentialProviderGetSignInIntentController;->invokePlayServices(LN/u;LN/k;Ljava/util/concurrent/Executor;Landroid/os/CancellationSignal;)V
    ...
    invoke-virtual {v0, p2, p5, p4, p3}, Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController;->invokePlayServices(LN/u;LN/k;Ljava/util/concurrent/Executor;Landroid/os/CancellationSignal;)V

    return-void
.end method

.method public onGetCredential(Landroid/content/Context;LN/z;Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;LN/k;)V
    .locals 0
...
.method public onPrepareCredential(LN/u;Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;LN/k;)V
    .locals 0
